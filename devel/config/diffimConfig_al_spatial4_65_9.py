...
config.imageDifference.subtract['al'].selectMeasurement.plugins['ip_diffim_DipoleFit'].minSn=9
...
# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.subtract['al'].selectMeasurement.plugins['ip_diffim_ClassificationDipole'].minSn=9

# Maximum flux ratio in either lobe to be considered a dipole
config.imageDifference.subtract['al'].selectMeasurement.plugins['ip_diffim_ClassificationDipole'].maxFluxRatio=0.65

# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.subtract['al'].selectMeasurement.undeblended['ip_diffim_DipoleFit'].minSn=9

# Maximum flux ratio in either lobe to be considered a dipole
config.imageDifference.subtract['al'].selectMeasurement.undeblended['ip_diffim_DipoleFit'].maxFluxRatio=0.65

# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.subtract['al'].selectMeasurement.undeblended['ip_diffim_ClassificationDipole'].minSn=9
...
# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.measurement.plugins['ip_diffim_DipoleFit'].minSn=9

# Maximum flux ratio in either lobe to be considered a dipole
config.imageDifference.measurement.plugins['ip_diffim_DipoleFit'].maxFluxRatio=0.65

# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.measurement.plugins['ip_diffim_ClassificationDipole'].minSn=9
...
# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.measurement.undeblended['ip_diffim_DipoleFit'].minSn=9

# Maximum flux ratio in either lobe to be considered a dipole
config.imageDifference.measurement.undeblended['ip_diffim_DipoleFit'].maxFluxRatio=0.65

# Minimum quadrature sum of positive+negative lobe S/N to be considered a dipole
config.imageDifference.measurement.undeblended['ip_diffim_ClassificationDipole'].minSn=9
